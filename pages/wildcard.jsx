...
A completely custom solution tailored to your specific needs
            ...
            <ProductFeature iconColor="text-yellow-6">
    Flexible pricing based on desired features and scope, discussed in advance
            </ProductFeature>
            <ProductFeature iconColor="text-yellow-6">
    Same 30-day support and money-back guarantee as for standard solutions</ProductFeature>
          </ProductCard>
    </SolutionsContainer>
    </>
  );
